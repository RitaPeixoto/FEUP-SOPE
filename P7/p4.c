...
/*
Modifique o programa do problema 1 desta folha,de modo a usar processos em vez de threads para preencher o 
buffer partilhado.O buffer deve ser criado numa região de memória partilha da e a sincronização deve ser 
feita com recurso a semáforos.*/
